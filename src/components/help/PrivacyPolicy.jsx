...
const PrivacyPolicy = () => {
  return (
    <div className="section">
      <h2 className="center" id="privacy">
        Privacy Policy
      </h2>

      <em>Effective date: December 26, 2018</em>

      <p>
        <strong>Ghosh Pro Solutions</strong> ("us", "we", or "our") operates the{" "}
        <a href="https://plan.ghosh.pro">https://plan.ghosh.pro</a> website (the
        "Service").
      </p>
      ...
      <p>React Planner uses the collected data for various purposes:</p>
      <ul className="pplist">
      ...
      <p>
        React Planner will take all steps reasonably necessary to ensure that
      ...
      <p>
        React Planner may disclose your Personal Data in the good faith belief
        that such action is necessary to:
      </p>
      <ul className="pplist">
        <li>To comply with a legal obligation</li>
        <li>To protect and defend the rights or property of React Planner</li>
        <li>
      ...
      <p>
        ...
        by email on <a href="mailto:admin@ghosh.pro">admin@ghosh.pro</a>
      </p>
    </div>
  );
};

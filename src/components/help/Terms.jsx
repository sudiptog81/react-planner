...
const Terms = () => {
  return (
    <div className="section">
      <h2 className="center" id="toc">
        <strong>Terms and Conditions</strong>
      </h2>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of the website located at https://plan.ghosh.pro.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use React Planner if you do not agree to
      ...
      <p>
        We employ the use of cookies. By accessing React Planner, you agreed to
        use cookies in agreement with the React Planner's Privacy Policy.
      </p>
      ...
      <p>
        Unless otherwise stated, Ghosh Pro Solutions and/or its licensors own
        the intellectual property rights for all material on React Planner. All
        intellectual property rights are reserved. You may access this from
        React Planner for your own personal use subjected to restrictions set in
        these terms and conditions.
      </p>

      <p>You must not:</p>
      <ul className="pplist">
        <li>Republish material from React Planner</li>
        <li>Sell, rent or sub-license material from React Planner</li>
        <li>Reproduce, duplicate or copy material from React Planner</li>
        <li>Redistribute content from React Planner</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Ghosh
        Pro Solutions does not filter, edit, publish or review Comments prior to
        their presence on the website. Comments do not reflect the views and
        opinions of Ghosh Pro Solutions,its agents and/or affiliates. Comments
        reflect the views and opinions of the person who post their views and
        opinions. To the extent permitted by applicable laws, Ghosh Pro
        Solutions shall not be liable for the Comments or for any liability,
      ...
      <p>
        Ghosh Pro Solutions reserves the right to monitor all Comments and to
      ...
      <p>
        You hereby grant Ghosh Pro Solutions a non-exclusive license to use,
      ...
      <p>
        ...
        the hyperlink compensates the absence of Ghosh Pro Solutions; and (d)
      ...
      <p>
        ...
        e-mail to Ghosh Pro Solutions. Please include your name, your
      ...
      <p>
        No use of React Planner's logo or other artwork will be allowed for

    ...
    <React.Fragment>
      <ul className="left hide-on-large-only">
        <li>
          <NavLink
            to="/user"
            className="left hide-on-large-only btn btn-floating btn-small white grey-text text-darken-3 extra"
            style={{
              margin: "auto 0",
              marginTop: ".8rem",
              fontWeight: "600",
      ...
      <ul className="right hide-on-med-and-down">
        ...
        <li>
          <NavLink
            to="/user"
            className="btn btn-floating white grey-text text-darken-3 hoverable"
            style={{
              fontWeight: "600",
              fontSize: "1.3rem",
              fontFamily: "cursive"
        ...
        <li>
          ...
          >
            <i
              className="fas fa-sign-out-alt grey-text text-darken-3"
      ...
      <ul className="right hide-on-large-only">
        <li>
          ...
          <NavLink
            to="/help"
            className="right hide-on-large-only btn btn-floating btn-small white grey-text text-darken-3 extra"
            style={{
              margin: "auto 0",
              marginTop: ".8rem",
              marginRight: ".5rem"
